...
import { Search, TrendingUp, LogIn, LogOut, User, Settings } from 'lucide-react'
...
const tabs = [
  ...
  { path: '/geri-test', label: 'Backtesting'    },
  { path: '/portfoy',   label: 'Portföy'        },
  { path: '/haberler',         label: 'Haberler'        },
  { path: '/ekonomik-takvim', label: 'Ekonomik Takvim' },
]
              ...
              <div className="relative">
                ...
                {userMenuAcik && (
                  <div className="absolute right-0 top-full mt-1 w-48 bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden z-50">
                    ...
                    <button
                      onMouseDown={() => { setUserMenuAcik(false); navigate('/ayarlar') }}
